...
const page = () => {
  return (
    <div className={styles.background}>
      <div className="w-full h-[22vh]  flex justify-center items-center bg-transparent">
        <Link href={"/"} className="text-white
        absolute left-[3%] w-[3vw] h-[3vw] bg-slate-500/65 flex justify-center items-center text-3xl rounded-full 
        "><GoArrowLeft /></Link>
        <h1 className="lg:text-[2.8vw] pt-[10vh] lg:pt-0  text-[10vw] font-semibold text-center text-white">
          CATALOGUE
        </h1>
      </div>
